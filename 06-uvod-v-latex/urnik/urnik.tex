...
omejitve so bile kršene ter kolikokrat se kršitev pojavi. S \(k\textsubscript{n}\) označimo število
kršitev omejitve \(n\), z \(u\textsubscript{n}\) pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
%vstavi formulo do konca
\[k\textsubscript{1}\]
